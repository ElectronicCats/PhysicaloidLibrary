...
This extension modified of [Arduino USB Serial Extension](https://community.thunkable.com/t/free-arduino-usb-serial-extension/2624) for all Arduino lovers to be used in your projects. This extension has been created using Physicaloid library.
